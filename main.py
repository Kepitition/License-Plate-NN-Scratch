...
from NN_scratch_nonsquare import *
from PIL import Image
import matplotlib.pyplot as plt
from crop_plate import contour_image, prepare_image_for_model, class_to_ascii

W1, b1, W2, b2, W3, b3 = load_model_parameters(r"Models/model_parameters_nonsquare.pkl")

image_path = r"Images/cropped/cropped_black_white_35_31GY737.jpg"
contours = contour_image(image_path, 100, 28, 56)

for letter in contours:
    normalized_array, normalized_image = prepare_image_for_model(letter, 28, 56)
