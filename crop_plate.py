...
def contour_image(full_image, threshold_value = 100, width = 28, height = 28):
    emptylist = []
    ...
    for idx, contour in enumerate(sorted_contours):
        ...
        if 5 < w < 150 and 10 < h < 200:
            ...
            resized_character = cv2.resize(character, (width, height), interpolation=cv2.INTER_AREA)
...
def prepare_image_for_model(letter, width = 28, height = 28):
    ...
    normalized_image = normalized_array.reshape((height, width)) * 255
